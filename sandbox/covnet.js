    ...
    d.prototype = {
        forward: function(h, k) {
            ...
            for (var t = 0; t < this.out_depth; t++) {
                ...
                var n = -this.pad | 0;
                var l = -this.pad | 0;
                for (var m = 0; m < this.out_sy; l += r,
                m++) {
                    n = -this.pad | 0;
                    for (var o = 0; o < this.out_sx; n += r,
                    o++) {
                        var v = 0;
        ...
        backward: function() {
            ...
            for (var t = 0; t < this.out_depth; t++) {
                ...
                var n = -this.pad | 0;
                var l = -this.pad | 0;
                for (var m = 0; m < this.out_sy; l += q,
                m++) {
                    n = -this.pad | 0;
                    for (var o = 0; o < this.out_sx; n += q,
                    o++) {
    ...
    b.prototype = {
        forward: function(l, u) {
            ...
            for (var p = 0; p < this.out_depth; p++) {
                var s = -this.pad;
                var q = -this.pad;
                for (var e = 0; e < this.out_sx; s += this.stride,
                e++) {
                    q = -this.pad;
                    for (var w = 0; w < this.out_sy; q += this.stride,
                    w++) {
                        var r = -99999;
                        var o = -1
                          , k = -1;
        ...
        backward: function() {
            ...
            for (var j = 0; j < this.out_depth; j++) {
                var l = -this.pad;
                var k = -this.pad;
                for (var e = 0; e < this.out_sx; l += this.stride,
                e++) {
                    k = -this.pad;
                    for (var m = 0; m < this.out_sy; k += this.stride,
                    m++) {
            ...
            var f = function() {
                ...
                for (var l = 0; l < e.length; l++) {
                    ...
                    if (n.type === "softmax" || n.type === "svm") {
                        m.push({
                            type: "fc",
                            num_neurons: n.num_classes
                        })
                    }
                    if (n.type === "regression") {
                        m.push({
                            type: "fc",
                            num_neurons: n.num_neurons
                        })
                    }
