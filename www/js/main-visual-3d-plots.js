...
var canvasInputScene;

// Store Training Data Spheres
const trainingDataSpheres = [];

export function canvasInputTrainingDataClear() {
    trainingDataSpheres.forEach(sphere => {
        canvasInputScene.remove(sphere);
...
export function canvasInputTrainingDataSet(training_data, training_data_estimates) {
    canvasInputTrainingDataClear();
    ...
    for (let i = 0; i < training_data.length; i++) {
        ...
        canvasInputTrainingDataAdd(x, y, z, label);
    }
}

// Function to add a point
function canvasInputTrainingDataAdd(x, y, z, label) {
    ...
    canvasInputScene.add(sphere);
    trainingDataSpheres.push(sphere);
}

export function renderCanvasInput(canvas, addTrainingDataCallBack) {
    // Scene, camera, renderer
    canvasInputScene = new THREE.Scene();
    canvasInputScene.background = new THREE.Color(0x1e1e1e);
...
//    document.body.appendChild(renderer.domElement);
    ...
    // Axes & Grid
    canvasInputScene.add(new THREE.AxesHelper(20));
    canvasInputScene.add(new THREE.GridHelper(20, 20, 0x404040, 0x404040));
...
//    canvasInputScene.add(new THREE.AmbientLight(0x404040));
    ...
    function onClick(event) {
        ...
        if (intersects.length > 0) {
            ...
            canvasInputTrainingDataAdd(point.x, point.y, point.z, label);
